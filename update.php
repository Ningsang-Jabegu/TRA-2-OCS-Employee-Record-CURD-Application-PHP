...
<head>
    <meta charset="UTF-8">
    <title>Update Record | Om Services Consultancy Pvt. Ltd.</title>
    ...
    <div class="container">
        <div class="wrapper mx-auto">
            <div class="container-fluid">
                <div class="row">
                    <div class="col-md-12">
                        <h1 class="dashboard-title">Update Employee Record</h1>
                        <p class="mb-4">Please edit the input values and submit to update the employee record.</p>
